    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="form-group" style="margin-top:15px">
                ...
                <?php }else{ ?>
                <label class="label label-danger label-lg">Đã kết thúc</label>
              ...
              <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input  value="<?php echo isset($detail['deposit_date'])  ? $detail['deposit_date'] : "" ?>" type="text" name="deposit_date" id="deposit_date" class="form-control datepicker">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
