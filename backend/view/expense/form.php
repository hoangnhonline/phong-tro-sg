    ...
    <div class="col-md-8">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"><?php echo ($id > 0) ? "Cập nhật" : "Tạo mới" ?> loại chi phí</h3>
            ...
            <form role="form" method="post" action="controller/Expense.php">
                ...
                <div class="box-footer">
                     ...
                     <button class="btn btn-primary" type="button" onclick="location.href='index.php?mod=expense&act=list'">Cancel</button>
                </div>
            </form>
        </div>
