...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <form method="post" action="controller/House.php">
         
        <div style="clear:both;margin-bottom:10px"></div>

         <div class="box-header">

            <h3 class="box-title"><?php echo (isset($id) && $id > 0) ? "Cập nhật" : "Tạo mới" ?> nhà </h3>
            <?php if($id > 0){ ?>
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="button col-md-7" style="background-color:#FFF">
                ...
                <div class="row">                    
                    ...
                    <div class="col-md-6" >
                        <div class="form-group">
                            ...
                            <input type="text" name="no_room" id="no_room" class="form-control" value="<?php if(isset($detail['no_room'])) echo $detail['no_room']; ?>" />
                        </div>
                    </div>
            ...
            <div class="col-md-5" style="border:1px solid #CCC;background-color:#FFF">
            <p style="padding:5px;background-color:#CCC;color:#000; text-align:center;text-transform:uppercase">Bảng giá dịch vụ</p>
            <div style="height:420px;overflow-y:scroll;">
                <?php if(!empty($serviceArr['data'])){ 
                    foreach($serviceArr['data'] as $v) {                         
                ?>
                <div class="col-md-12">
                    <div class="col-md-1">
                        <label>&nbsp;</label>
                        <input type="checkbox"
                        <?php if(array_key_exists($v['id'], $arrServiceSelected)) echo "checked"; ?>
                         value="<?php echo $v['id']?>" name="service_id[]">
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            <label><?php echo $v['name']; ?></label>
							<?php 
							$price = isset($arrServiceSelected[$v['id']]['price']) ?  $arrServiceSelected[$v['id']]['price'] : $v['price'];
							?>
							
                            <input type="text" name="services_price[]" class="form-control number" value="<?php echo number_format($price); ?>" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tính tiền theo</label>
                            <select class="form-control" name="service_cal_type[]">
                                <option value='0'>--chọn--</option>
                                <option value='1' 
                                <?php if((isset($arrServiceSelected[$v['id']]['cal_type']) && $arrServiceSelected[$v['id']]['cal_type'] == 1) || $v['cal_type'] == 1) { echo "selected"; } ?>>Phòng</option>
                                <option value='2' <?php if((isset($arrServiceSelected[$v['id']]['cal_type']) && $arrServiceSelected[$v['id']]['cal_type'] == 2)|| $v['cal_type'] == 2){ echo "selected"; }elseif($v['cal_type']==1){ echo "selected"; }?>>Số lượng người</option>
                                <option value='3' <?php if((isset($arrServiceSelected[$v['id']]['cal_type']) && $arrServiceSelected[$v['id']]['cal_type'] == 3)|| $v['cal_type'] == 3) echo "selected"; ?>>Số lượng sử dụng</option>
                            </select>
                        </div>
                    </div>
                </div>
